# original resource url: https://github.com/Zuzu-Typ/XInput-Python
# 要在win7能正常運作需把XInput.py裡第140~145行註解掉
# 為了客制需求在行558處加上 global_var_obj (2020/12/19 )
...
class EventHandler:
    def __init__(self, *controllers, filter = FILTER_NONE, global_var_obj=None):
        self.set_controllers(*controllers)
        self.filter = filter
        self.global_var=global_var_obj
